        ...
        <div class="banner_inner d-flex align-items-center">
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <div class="page_link">
                        <a href="<?php echo base_url('index.php/userferia/stands/inicio?id_feria=').$this->session->userdata['feria']->id_feria ?>"><?php echo $this->session->userdata['feria']->nombre_feria ?></a>
                        <a>Productos</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row my-4 pt-4">
                <div class="col-md-4 text-center pt-4">
                    <div class="form-group">
                        ...
                        <select class="form-control lista-stands" name="buscar_ventas" value="0" onchange="listar_v()">
                            <!-- lista stands -->
    ...
    <script>
        ...
        function consultar_v(){
            $.ajax({
                url: 'ventas/consultar_ventas_feria',
                type: 'GET',
        ...
        function consultar_g(){
            $.ajax({
                url: 'ventas/consultar_gastos_feria',
                type: 'GET',
                success: function(res){
        ...
        function listar_v (){
            var salida_d = "";
            var total_v = 0;
            var buscar_ventas = $('select[name="buscar_ventas"]').val();
            ...
            for (var i=0; i < ventas.length; i++){
                ...
                if(buscar_ventas == '0'){
                    ...
                    if(ventas[i].id_stand == buscar_ventas){
                        salida_d += salida;
                        total_v += parseInt(ventas[i].total);
                    }
                }
        ...
        function listar_g (){
            var salida_d = "";
            var total_g = 0;
            var buscar_gasto = $('select[name="buscar_ventas"]').val();
